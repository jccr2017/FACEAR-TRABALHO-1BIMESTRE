	...
	<c:when test="${not empty listaClientes}">
		<table>
			<tr>
				...
				<th><strong>Defeito</strong></th>
				<th><strong>Valor Conserto</strong></th>
			...
			<tr>
				...
				<td>${cliente.data}</td>
				<td>${cliente.hora}</td>
				<td>${cliente.defeito}</td>
				<td>${cliente.valorconserto}</td>
				...
				<!-- 
					...
					<a href="/Trabalhojava1/ExcluirClienteServlet?id=${cliente.id}">Excluir</a>
					</td>
				
				<td> <a href="/Trabalhojava1/ObterClienteServlet?id=${cliente.id}">Exibir</a> </td>
...
<center>
<form action="/FacearTrabalho1/Buscaporcpf" method="post">
</br>
</br>
</br>


Para mudar o status do serviço, insira o cpf do cliente:
</br>
