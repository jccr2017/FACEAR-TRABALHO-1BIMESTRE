	 ...
	 <!-- <li><a href="#">Contato</a></li> -->   
		...
		<li><a href="#">Opções</a>
		    ...
		    <ul>
                ...
                <li><a href="/FacearTrabalho1/ObterClienteServlet?id=${cliente.id}">Alterar Conta</a></li>
			    <li><a href="/FacearTrabalho1/ObterExcluirC?id=${cliente.id}">Excluir conta</a></li>
